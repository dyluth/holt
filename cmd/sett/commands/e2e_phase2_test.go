...
func TestE2E_Phase2_HappyPath(t *testing.T) {
	...
	env.VerifyFileContent(goalFilename, "File created by Sett example-git-agent")
	...
	t.Log("  1. sett up - launched orchestrator + agent")
	t.Log("  2. sett forage - created GoalDefined artefact")
