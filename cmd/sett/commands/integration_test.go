...
// Run with: go test -tags=integration -v ./cmd/sett/commands
...
// TestUpSuccess verifies the complete success path for sett up
func TestUpSuccess(t *testing.T) {
	...
	// Execute: sett up --name test-up-success directly
